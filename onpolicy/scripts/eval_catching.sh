...
exp="evaluate"
seed_max=1
model_dir="/workspace/on-policy/onpolicy/scripts/results/MPE/simple_catching/rmappo/EnvV0.1_TargetSpeed0.0_NewReward_AddPunish_ForExclusive_Linear/wandb/run-20220917_205957-2c83buvw/files"
load_model_ep=4100
