...
exp="debug"
seed_max=1
model_dir="/workspace/on-policy/onpolicy/scripts/results/MPE/simple_catching_expert_prey/rmappo/TargetSpeed1.0_new_reward_addpunish_rwscale0.5_Expert_High-Sucess-rw/wandb/run-20220928_163625-2qb9eiks/files"
load_model_ep=2800
num_test_episode=10
