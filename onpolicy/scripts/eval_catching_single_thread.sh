...
exp="debug"
seed_max=1
model_dir="/workspace/on-policy/onpolicy/scripts/results/MPE/simple_catching/rmappo/EnvV0.1_TargetSpeed0.0_NewReward_AddPunish_ForExclusive_Linear_scale9/wandb/run-20220918_104216-1mhl0oj7/files"
load_model_ep=4100
