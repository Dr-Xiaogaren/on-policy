...
exp="debug"
seed_max=1
model_dir="/workspace/on-policy/onpolicy/scripts/results/MPE/simple_catching_expert_prey/rmappo/TargetSpeed1.0_new_reward_addpunish_rwscale0.5_Expert/wandb/run-20220927_191058-iamgc0zi/files"
load_model_ep=1900
num_test_episode=10
