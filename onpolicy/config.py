...
def get_config():
    ...
    # environment
    parser.add_argument("--maps_path", type=str, default="/workspace/scene", help="by default None. set the path to the gibson travasable map image directory.")
    ...
    parser.add_argument("--step_mode", type=str, default="expert_both", help=" assert mode == expert_adversary or mode == expert_both or mode == expert_prey or mode == none" )
