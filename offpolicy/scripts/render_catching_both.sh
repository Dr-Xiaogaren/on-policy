...
exp="debug"
seed_max=1
model_dir="/workspace/on-policy/offpolicy/scripts/results/MPE/simple_catching_expert_both/rmappo/EnvV4_ExpPrey_NoPreyVolo_AddMAAC_test/wandb/run-20230226_212404-1l30zxna/files"
load_model_ep=2400
num_test_episode=10
