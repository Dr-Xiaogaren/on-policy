...
def get_config():
    ...
    # environment
    parser.add_argument("--maps_path", type=str, default="/home/zh/Documents/workspace/scene/candidate", help="by default None. set the path to the gibson travasable map image directory.")
